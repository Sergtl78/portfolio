...
fioriopt.ru - closed site for wholesale of flowers. Fullstack application on NextJS, Typescript, Zustand, css - Tailwind, UI - shadcn.ui, DB - Postgres, ORM - Prisma.  For management I wrote CMS and CRM for the needs of the customer. CI CD was implemented via githab.
...
- Authentication with Ayth.js : Yandex, Google, with email
